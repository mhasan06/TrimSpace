    ...
    <main style={{ 
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem' }}>
          {/* Profile Overview */}
          <div style={{ background: '#fff', padding: '2.5rem', borderRadius: '32px', boxShadow: '0 15px 35px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9' }}>
            <h2 style={{ fontSize: '1.25rem', fontWeight: 900, marginBottom: '2rem', color: '#000' }}>Personal Details</h2>
            ...
            <form onSubmit={handleUpdate} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <div>
                  <p style={{ margin: 0, fontWeight: 800, fontSize: '1.1rem' }}>{session.user?.email}</p>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: '#64748b', fontWeight: 600 }}>Your account email cannot be changed.</p>
                </div>
              </div>
